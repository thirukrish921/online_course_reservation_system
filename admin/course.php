...
$ret=mysqli_query($con,"insert into department(department) values('$coursename')");
if($ret)
{
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
 ...
 <div class="form-group">
    <label for="coursename">Conference Name  </label>
    <input type="text" class="form-control" id="coursename" name="coursename" placeholder="Conference" required />
  </div>
